...
| A.5.40 | HLT – Validatie van getoonde/geprinte gegevens | Zorgspecifieke beheersmaatregel: Als er gegevens worden getoond en/of geprint door gezondheidsinformatiesystemen moeten deze gegevens ook informatie omvatten waarmee de zorgontvanger waarop de gegevens betrekking heeft wordt geïdentificeerd. | Ja | Ja | Integriteitscontroles borgen dat weergegeven/geëxporteerde feedback overeenkomt met opgeslagen gegevens zonder wijziging. | Nee | Secure Development & Change Management |
| A.5.41 | HLT – Openbaar beschikbare gezondheidsinformatie | Zorgspecifieke beheersmaatregel: Openbaar beschikbare gezondheidsinformatie moet worden beschermd, bewaard en beheerd gedurende de volledige levenscyclus. | Ja | Ja | Rate publiceert geen gezondheidsgegevens openbaar; uitsluitend volledig geanonimiseerde statistische gegevens in geaggregeerde rapportage. | Nee | Information Security Policy; Asset Management Policy |
| A.5.42 | HLT – Communicatie in noodsituaties | Zorgspecifieke beheersmaatregel: Noodcommunicatiekanalen binnen een zorgorganisatie die in werking treden wanneer er een storing is in de continuïteit van de ICT van de organisatie moeten worden gepland, geïmplementeerd, onderhouden en beproefd. | Ja | Ja | Bij een groot incident dat de beschikbaarheid van gezondheidsgegevens raakt, worden zorgklanten direct geïnformeerd om continuïteit van zorg te behouden. | Nee | BCDR Plan; Incident Management & Response Plan |
| A.5.43 | HLT – Incidenten extern melden | Zorgspecifieke beheersmaatregel: Informatiebeveiligingsincidenten moeten volgens juridische of contractuele verplichtingen of verplichtingen uit hoofde van wet- en regelgeving worden gemeld. | Ja | Ja | Rate (verwerker) informeert zorgklanten (verwerkingsverantwoordelijken); klanten verzorgen externe melding aan autoriteiten. Rate ondersteunt binnen de AVG-termijn van 72 uur. Verantwoordelijkheid vastgelegd in BOZ-addendum (IMP-2026-NEN-01). | Deels: externe melding aan autoriteiten door zorgaanbieder (verwerkingsverantwoordelijke); Rate ondersteunt | Incident Management & Response Plan; BOZ-addendum (IMP-2026-NEN-01) |
| A.6.9 | HLT – Managementtraining | Zorgspecifieke beheersmaatregel: Het management van de organisatie moet passende training krijgen, naarmate relevant is voor hun rollen en verantwoordelijkheden met betrekking tot informatiebeveiliging en hoe het wordt beheerd. | Ja | Ja | Jaarlijkse security-awarenesstraining; CEO getraind over verplichtingen inzake gezondheidsinformatiebeveiliging en NEN 7510-verantwoordelijkheden. | Nee | Information Security Policy; Training & Awareness (Logs §1) |
| A.8.35 | HLT – Zero trust-beginselen | Zorgspecifieke beheersmaatregel: Aan een netwerksegment toegewezen groepen informatiediensten, gebruikers en informatiesystemen moeten zo klein mogelijk worden gehouden en mogen slechts toegang tot een ander netwerksegment hebben nadat beide betrokken segmenten elkaar hebben geauthentiseerd. | Ja | Gedeeltelijk | Rate past diverse zero-trust-principes toe (RBAC least-privilege, VPN-geverifieerde toegang, IP-whitelisting, dev/prod-scheiding, CrowdSec-monitoring). Een volledige, formele zero-trust-architectuur is niet geïmplementeerd; acceptabel omdat dit geen certificeringseis van NEN 7510 is. | Nee | Access Control Policy; Netwerkbeveiliging (A.8.20–A.8.22) |
...
| ID | Title | Description (control text — NEN 7510-1:2024, Annex A) | Applicable | Implemented | Reason for inclusion / exclusion | Outsourced (partly) | Related policy / process |
|----|-------|-------------------------------------------------------|------------|-------------|----------------------------------|---------------------|--------------------------|
| | **Shared controls with a healthcare dimension (additional to ISO 27001)** | | | | | | |
| A.5.1 | Information security policies | Control: Information security policy and topic-specific policies shall be defined, approved by management, published, communicated to and acknowledged by relevant personnel and relevant interested parties, and reviewed at planned intervals and if significant changes occur.<br>**Healthcare-specific (additional):** The information security policy shall describe the approach to managing information security, be approved by top management, and be reviewed at least once a year and whenever a serious security event occurs. | Yes | Yes | ISMS Information Security Policy applies; addresses health-data protection; references Wkkgz, Wabvpz, NEN 7510-1:2024. | No | Information Security Policy |
| A.5.2 | Information security roles and responsibilities | Control: Information security roles and responsibilities shall be defined and allocated according to the organization's needs.<br>**Healthcare-specific (additional):** At least one person shall be responsible for information security. | Yes | Yes | Roles defined in ISMS Manual §4; health-data responsibility with ISO Lead, accountability with CEO. | No | Information Security Policy; Access Control Policy; BCDR Plan; Incident Management Plan |
| A.5.9 | Inventory of information and other associated assets | Control: An inventory of information and other associated assets, including owners, shall be developed and maintained.<br>**Healthcare-specific (additional):** All information flows (within and between organizations) and their interfaces (including integration platforms) shall be included in the inventory. | Yes | Yes | Asset inventory maintained; health data identified separately and classified as special-category data. | No | Asset Management Policy |
| A.5.11 | Return of assets | Control: Personnel and other interested parties, as appropriate, shall return all of the organization's assets in their possession upon termination of their employment, contract or agreement.<br>**Healthcare-specific (additional):** A policy shall require individuals to confirm in writing that all assets in their possession, in all formats, have been securely returned or disposed of, where applicable. | Yes | Yes | Device Offboarding Checklist covers return; ensures no health data remains. | No | Asset Management Policy; Device Offboarding Checklist |
| A.5.12 | Classification of information | Control: Information shall be classified according to the organization's information security needs, based on requirements for confidentiality, integrity, availability and relevant interested-party requirements.<br>**Healthcare-specific (additional):** Personal health information shall be uniformly classified as confidential. | Yes | Yes | Health data at highest sensitivity tier with strongest controls. | No | Asset Management Policy; Information Labelling Procedure |
| A.5.14 | Information transfer | Control: Rules, procedures or agreements for information transfer shall be in place for all types of communication facilities within the organization and between the organization and other parties.<br>**Healthcare-specific (additional):** Before any transfer takes place, rules, procedures and agreements shall be in place. | Yes | Yes | Secure transfer via TLS/VPN; health data encrypted in transit, restricted to authorized healthcare-customer tenants. | Yes (partly): transfer via cloud providers (Hetzner, Google) under shared responsibility | Asset Management Policy §4.4 (Information Transfer); Access Control Policy |
| A.5.15 | Access control | Control: Rules to control physical and logical access to information and other associated assets shall be established and implemented based on business and information security requirements.<br>**Healthcare-specific (additional):** A role-based access control policy shall apply to access to personal health information. | Yes | Yes | Role-based access control; health-data access strictly need-to-know per healthcare-customer tenant. | No | Access Control Policy |
| A.5.16 | Identity management | Control: The full lifecycle of identities shall be managed.<br>**Healthcare-specific (additional):** Users who wish to access personal health information and other confidential information shall be formally registered. | Yes | Yes | Unique identity per user; health-data access only via authenticated, authorized identities. | No | Access Control Policy |
| A.5.19 | Information security in supplier relationships | Control: Processes and procedures shall be defined and implemented to manage the information security risks associated with the use of the supplier's products or services.<br>**Healthcare-specific (additional):** The risks associated with external-party access to systems or the data they contain shall be assessed, and controls appropriate to the identified risk implemented. | Yes | Yes | Sub-processors of health data (Hetzner) bound by DPA with healthcare-grade requirements. | Yes (partly): Hetzner as sub-processor (hosting/storage of health data) under DPA | Supplier Security & Contractual Obligations |
| A.6.2 | Terms and conditions of employment | Control: Employment contracts shall state the personnel's and the organization's responsibilities for information security.<br>**Healthcare-specific (additional):** Job descriptions shall state the security roles and responsibilities applicable to processing personal health information. | Yes | Yes | Employment contracts include confidentiality; staff with health-data access bound to medical confidentiality. | No | Access Control Policy; Employment/HR agreements |
| A.6.6 | Confidentiality or non-disclosure agreements | Control: Confidentiality or non-disclosure agreements reflecting the organization's needs for the protection of information shall be identified, documented, regularly reviewed and signed by personnel and other relevant interested parties.<br>**Healthcare-specific (additional):** All personnel authorized to access personal health information shall be formally required to treat that information confidentially. | Yes | Yes | NDAs explicitly cover health data and medical secrecy. | No | Access Control Policy; NDAs / Confidentiality agreements |
| A.7.10 | Storage media | Control: Storage media shall be managed through their lifecycle of acquisition, use, transportation and disposal in accordance with the organization's classification scheme and handling requirements.<br>**Healthcare-specific:** All personal health information stored on removable media shall be encrypted. | Yes | Yes | Removable media prohibited and technically enforced; media with health data encrypted and securely wiped before disposal/reuse. | No | Asset Management Policy; Access Control Policy |
| A.8.5 | Secure authentication | Control: Secure authentication technologies and procedures shall be implemented based on information access restrictions and the topic-specific access control policy.<br>**Healthcare-specific (additional):** At least two-factor authentication shall be used for systems processing personal health information. | Yes | Yes | MFA mandatory for systems with health data; where native MFA is unsupported (CMS), IP whitelisting applies as a documented, risk-accepted compensating control (Risk #28). | No | Access Control Policy §MFA; Risk #28 (compensating control) |
| A.8.13 | Information backup | Control: Backup copies of information, software and systems shall be maintained and regularly tested in accordance with the agreed topic-specific backup policy.<br>**Healthcare-specific (additional):** Backups of personal health information shall be encrypted. | Yes | Yes | Backups encrypted, retained per legal requirements, recoverable within 4-hour RTO; monthly restore tests. | Yes (partly): backup infrastructure at Hetzner (production) and Azure (failover); management/restore tests by Rate | BCDR Plan §5 (Backup and Recovery Procedures) |
...
| **ISMS Scope (ISO 27001:2022 & NEN 7510-1:2024)** | 2026-09-24 | Firas Kassoumeh (ISO Lead) | ✅ Yes | CEO (Inge Proost) | 2026-09-25 | ✅ Approved | Scope aligned to registered scope (Proost Works B.V., incl. CareRate B.V. and DineRate B.V.; bilingual NL/EN). Legal-compliance reference (Wkkgz/Wabvpz) removed from the scope statement per DigiTrust Stage 2 feedback, as certification does not attest legal compliance; the legislation remains in the Legal & Regulatory Register. |

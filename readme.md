...
| A.7.5 | Protecting against physical/environmental threats | ✅ | Physical and environmental threats to home office infrastructure (NAS, Dev Server) are mitigated through locked room, camera surveillance, and intrusion alarm (CEO home office). Cloud infrastructure physical threats are managed by Hetzner under SLA, reviewed annually. UPS procurement under evaluation following IR-2026-001. | Asset Management Policy, Supplier Security & Contractual Obligations | CEO / Team Lead Developer |

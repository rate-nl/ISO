...
| IMP-2025-EXT-01| Improvement Point | Operational planning | OFI            | Operational planning did not clearly evidence that tasks were executed.                  | Execution tracking not consistently documented.      | Operational planning & logs             | Improve evidence of execution in planning logs.     | Merge audit calendar & change log to track execution.              | Planned 30 Oct 2025                                    | Firas                | 🔄 Open  |

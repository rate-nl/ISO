...
## 1. Introduction
   - [Context of the Organization (Clause 4.1)](#context-of-the-organization-clause-41)
...
|---|-------|---------------------|--------------------------------------|--------------------------|
| 1 | Small organization size | Internal | Rate operates with a very small team. Full segregation of duties is not achievable; ISMS roles are concentrated in two individuals. Managed via compensating controls (CEO oversight, independent external audit, privileged-action logging). | Risks #14, #15; Segregation of Duties Statement (§4.6) |
...
- **Evidence of Competence (Clause 7.2):** Objective evidence that each person meets their stated competency requirements is retained in HR records — including CVs, relevant certifications, and completed training records mapped to the competencies above. For the ISO Lead this includes demonstrated ISMS implementation experience and secure-development/access-control knowledge; for the external auditor performing the independent ISMS review, the qualifications defined in the Independent ISMS Review Terms of Reference (§4.6). Competence evidence is reviewed at onboarding and annually.
- 
...
> **Segregation of Duties Statement:** Rate is a small organization in which ISMS roles are concentrated between two individuals: Inge Proost (CEO / Managing Director / ISMS Owner) and Firas Kassoumeh (ISO Lead / Technical Security Lead). Full segregation of duties is not achievable at this organizational size. The associated risk is managed through compensating controls: (1) the CEO independently approves all risk treatment, policy, and access decisions; (2) an independent ISMS review is performed at least annually by an external party (currently Jaguar IT), providing independent assurance of the ISMS; and (3) all privileged actions are logged and reviewed. This arrangement is documented, accepted as a residual risk, and reviewed annually.


> **Independent ISMS Review — Terms of Reference (A.5.35):** As a compensating control for limited segregation of duties, an independent review of the ISMS is performed by an external party that is independent of Rate's day-to-day operations. **Scope:** ISMS implementation, risk management, access controls, and corrective actions. **Frequency:** at least annually. **Provider / qualifications:** an external information-security auditor with ISO 27001 audit competence (currently Jaguar IT — Steven Vogelaar, Lead Auditor). **Independence:** the reviewer has no role in Rate's operational management. Findings are reported to the CEO, tracked in the Corrective Actions register, and recorded in the ISMS Review & Approval Log.
...
| Interested Party / Stakeholder | Needs / Requirements / Issues | How Addressed / Monitored |
|-------------------------|-------------------------------|---------------------------|
| Customers | - Confidentiality, integrity, and availability of their data (survey/customer/end-user data)<br>- Reliable access to Rate platform and services<br>- Timely incident notification<br>- Contractual clarity and compliance<br>- Protection against misuse of the platform by other users or Rate itself | DPAs & SLAs; RBAC and encryption; Incident Management Plan (notification); reviewed at annual Management Review and supplier review |
| Rate Employees | - Secure handling of personal and HR data<br>- Reliable, secure devices for work (laptop/desktop)<br>- Safe remote work and VPN access<br>- Training and awareness on security and policies<br>- Privacy of employment records<br>- Clear onboarding/offboarding processes | Access Control Policy; encrypted managed devices; VPN; Training Completion Log (Logs §1); Onboarding/Offboarding checklists (Logs §10); reviewed annually |
| Respondents (Survey End-Users) | - Confidentiality and integrity of submitted survey/health data<br>- Proper retention and deletion of their data<br>- Protection of sensitive/health information | Encryption in transit/at rest; per-tenant access; retention & deletion policy (A.8.10); health data classified Restricted |
| Trainers | - Reliable demo/training environment<br>- Protection of training data and materials<br>- Timely support for training needs | Access control on training environment; DPA; supplier review |
| Suppliers/Service Providers (Hosting, VPN, WiFi, CRM, Support, Mailstreet, Trainers, etc.) | - Clear contracts and SLAs<br>- Secure handling of Rate/customer data<br>- Defined responsibilities for data protection<br>- Timely communication of incidents<br>- Compliance with security requirements (e.g., DPA, GDPR, ISO 27001) | Supplier Security Assessment Log & annual supplier review; DPAs and contracts; certifications verified via trust centres |
| Home-Office Physical Security (CEO) | - Physical security of home-office equipment (NAS, Dev Server, UPS), CEO-only access to critical assets | Locked room, intrusion alarm, camera surveillance, CEO-only access; Risk #42 (closed); BCDR §6.5 |
| Owners/Management | - Business continuity<br>- Protection of company reputation<br>- Regulatory compliance<br>- Risk management and reporting<br>- Knowledge retention and succession planning | BCDR plan; risk register & treatment plan; KPIs and Management Review (Logs §13); compliance register |
| Regulators/Authorities | - Compliance with legal and regulatory requirements (GDPR, ISO 27001)<br>- Timely breach notification<br>- Evidence of risk management and controls | Legal & Regulatory Register; breach-notification procedure (Incident Plan); ISMS records retained 3 years; ISO 27001 certification maintained |
| IT/Hosting Providers | - Reliable, secure infrastructure<br>- Data loss prevention and backup<br>- SLA compliance for uptime, maximum outage/data loss (MUD/MGV)<br>- Secure data processing and storage | Hetzner SLA + Azure failover; daily backups & monthly restore tests (Logs §4); supplier review |
| Support Platform Providers | - Secure handling of customer and support data<br>- Compliance with retention and privacy requirements | DPA; retention & privacy policy; Freshdesk assessed in supplier review |
...
| 23 | Rate | Team Lead Developer | Certificate management | SSL certificate expiry | Fully | Website/app inaccessible, loss of trust, possible data exposure | Medium 🟡 | Low 🟢 | Low | A.8.24, A.8.23 |
...
| 28 | Rate                    | Rate               | Authentication compliance | CMS does not support native 2FA, but static IP whitelisting is enforced | Mostly | Data breach or unauthorized access if IP control fails | Medium 🟡 | Low 🟢 | Medium | A.5.17, A.8.28 |
...
| 30 | Rate | CEO | Physical security (home office) | Physical intrusion / burglary at the CEO's home office | Mostly | Unauthorized access, theft or destruction of assets/information | High 🔴 | Low 🟢 | Medium | A.7.1, A.7.2, A.7.3, A.7.4 |
| 31 | Rate | CEO | Fire safety (home office) | Fire prevention/detection failure at the home office | Mostly | Fire or smoke causes loss of local equipment; cloud backups unaffected | High 🔴 | Low 🟢 | Medium | A.7.5, A.7.8, A.7.11 |
| 32 | NAS device              | Team Lead Developer | Backup security & endpoint protection | Unauthorized access or malware infection on NAS device storing backup and logs | Mostly | Access restricted to trusted IPs; firewall configured; physical access controlled | Medium 🟡 | Low 🟢 | Low | A.8.9, A.8.25 |
...
| 7 | Losing access to head office systems | Mitigate | Ensure production server firewall rules can be modified securely without VPN access. Maintain alternative access methods. Refer to the Access Control Policy – Section 7 and BCDR Plan – Section 6.3. | Developers | Alternative access | Alternative access re-tested at BCDR drill DRILL-003 on 2026-08-27 (physical NAS / dev-server access + Hetzner firewall IP whitelisting) — successful. Next test due Aug 2027. See Alternative Access Method Test Log Section 12. | Yes | Low 🟢 | Low 🟢 | Acceptable if alternative means of accessing production servers exist and are tested annually. | ✅ Closed — next test Aug 2026 |
...
| 10 | Internet provider outage or degradation | Transfer | SLA with provider; backup connectivity via mobile 4G tethering (CEO's phone) for emergencies; regular provider review | Internet Provider | Provider SLA; mobile 4G tethering (CEO's phone) | SLA in place; mobile 4G tethering available, validated live during IR-2026-002 (Ziggo outage, Aug 2026) and tested as ALT-2026-001; provider reviewed annually | Yes | Medium 🟡 | Low 🟢 | Acceptable if SLA and mobile backup connectivity are maintained. | Ongoing |
...
| 28 | CMS does not support native 2FA | Mitigate | 2FA enforced for all critical cloud services (Google Workspace, GitHub, LastPass, Trello, GDrive). CMS access protected via static IP whitelisting and firewall controls. | Managing Director | A.5.17, A.8.28 | ✅ Yes | ✅ Implemented | Low 🟢 | Low 🟢 | Acceptable with compensating control (IP restriction) | Closed  |
...
| 30 | Physical intrusion (burglary) at home office | Mitigate | Critical devices (NAS, Dev Server, UPS) secured in a locked, access-controlled room in the CEO's home; reinforced locks, intrusion alarm, and camera surveillance at all entry points; CEO-only access; regular footage and asset reviews. | CEO | Physical access control, alarm, surveillance | Yes | Medium 🟡 | Low 🟢 | Acceptable if physical controls (locks, alarm, cameras, CEO-only access) are maintained and reviewed. | Ongoing |
| 31 | Fire prevention/detection failure at home office | Mitigate | Home office equipped with smoke detection; devices in a protected room; critical data continuously backed up to Hetzner cloud so a home-office fire does not cause data loss; BCDR plan includes fire scenario (§6.5). | CEO | Fire detection, cloud backup, BCDR plan | Yes | Medium 🟡 | Low 🟢 | Acceptable if fire detection is maintained and cloud backups remain current and tested. | Ongoing |
...
- **Web Filtering and Internet Access:** As Rate operates a home-office model (no shared office premises), internet access is via managed endpoints with VPN enforced and endpoint protection (antivirus) active on all devices. Web-filtering/malicious-site protection is provided at the endpoint level rather than by a building/network provider.
...
| **6.3 Internet Outage at CEO's Home (Network / VPN Unavailable)** | When the home network is down, VPN access is unavailable. Restore connectivity via mobile 4G tethering from the CEO's phone (standing backup connectivity method). Access the NAS and development server physically on-site. Restore production access by whitelisting the active connection IP on the Hetzner firewall dashboard. See Alternative Access Method Test Log (Logs §12). | Managing Director / Team Lead Developer | Immediate | None |
...
| **6.5 Calamities (Fire, Flood, Physical Theft at Home Office)** | Ensure personal safety first, then notify the Managing Director. Critical devices (NAS, Dev Server, UPS) are secured in a locked room; all critical data is continuously backed up to the Hetzner cloud, which remains unaffected by any home-office incident. Restore from cloud backup if home-office equipment is lost or damaged. Physical protection (locks, alarm, cameras, CEO-only access) reduces intrusion/fire impact. | CEO | As feasible | 30 minutes |
...
| **6.9 Climate-related disruption at hosting provider (e.g., extreme weather, fire, flood)** | Follow Hetzner SLA for resilience. If outage >4h, trigger Azure failover per BCDR. Verify provider climate resilience annually during supplier review. | Team Lead Developer | 4 hours | 30 minutes |
...
- **Test Components:** Server restoration (Hetzner → Azure), alternative access (physical NAS / development-server access + Hetzner firewall IP whitelisting), LastPass recovery, UPS power resilience
- **Review Cycle:** **Annual** or after any major incident or infrastructure change
- **Responsible for Testing:** Managing Director.
- **Power Continuity:** Following IR-2026-001 (Mar 2026 NAS power outage), power continuity at the home office is included as a BCDR consideration. UPS installed June 2026 (RA-2026-001). Power resilience verified at annual BCDR drill DRILL-003 (27 Aug 2026): the NAS remained available on the UPS with no boot failure or backup gap (Risk #42 closed).
...
- **Role Assignments:**
  ...
  - **Legal Ownership vs. ISMS Custodian Role:**
  Rate distinguishes **legal ownership** of assets from the **ISMS asset-owner (custodian) role**. Legally, all assets belong to the relevant Rate entity — **DineRate B.V.** or **CareRate B.V.** — as recorded in the asset register. For ISMS purposes, the **Team Lead Developer** is the asset owner for hardware and data, responsible for maintenance, backups, and classification. The **CEO** holds **physical custody** of the home-office devices (NAS, Development Server, UPS) secured in the locked, access-controlled room. Where the critical-asset table lists the CEO as "Owner," this denotes the **physical custodian**; the ISMS maintenance/responsibility role remains with the Team Lead Developer.
...
| A.5.2                  | Information security roles and responsibilities | ✅         | Roles and responsibilities are defined in the Information Security Policy, Access Control Policy, BCDR Plan, and Incident Management Plan. Evidence includes clearly documented responsibilities for CEO, Managing Director, Team Lead Developer, and Employees. | Information Security Policy, Access Control Policy, BCDR Plan, Incident Management Plan | CEO & Managing Director     |
...
| A.5.4                  | Management responsibilities   | ✅         | Top management responsibilities are formally documented in the Information Security Policy and evidenced through Management Review and Corrective Actions. | Information Security Policy, Management Review, Corrective Actions Log | CEO & Managing Director |
| A.5.5                  | Contact with authorities      | ✅         | Required for GDPR compliance (e.g., data breach reporting). Covered in Incident Management & Response Plan, which defines communication with regulators and customers. | Incident Management and Response Plan          | CEO                     |
| A.5.6 | Contact with special interest groups | ✅ | Rate monitors public advisories and threat intelligence from industry groups including CrowdSec community feeds and ENISA advisories as part of threat intelligence activities (A.5.7). No formal membership is maintained but public sources are actively monitored. | Secure Development & Change Management, Threat Intelligence & Cloud Exit Review | Team Lead Developer |
...
| A.5.8                  | Information security in project management | ✅         | Security is embedded in project management through the Secure Development & Change Management process, including risk analysis swimlanes in the Kanban workflow. Major projects (e.g., Remote Work Transition Plan 2025) also include security risk assessments and ISMS updates. | Secure Development & Change Management, Risk Assessment, Remote Work Transition Plan | Managing Director & Team Lead Developer |
...
| A.5.14                 | Information transfer          | ✅         | Information transfer is secured using TLS, VPN, and encrypted cloud services; USB/removable media are prohibited; health data encrypted in transit and tenant-restricted. Defined in Asset Management Policy §4 (Information Transfer). | Asset Management Policy, Access Control Policy | Team Lead Developer & Managing Director |
...
| A.5.35 | Independent review of information security | ✅ | An independent review of the ISMS is performed at least annually by an external party (currently Jaguar IT) per the documented Terms of Reference (§4.6), alongside external certification audits. | Independent ISMS Review ToR, External Audit Reports | CEO |
...
| A.7.5 | Protecting against physical/environmental threats | ✅ | Physical and environmental threats to home office infrastructure (NAS, Dev Server) are mitigated through locked room, camera surveillance, and intrusion alarm (CEO home office). Cloud infrastructure physical threats are managed by Hetzner under SLA, reviewed annually. UPS installed June 2026 IR-2026-001. | Asset Management Policy, Supplier Security & Contractual Obligations | CEO / Team Lead Developer |
| A.7.6 | Working in secure areas | ✅ | The CEO's home office functions as Rate's secure area for infrastructure hosting. Access is strictly limited to CEO only, room is locked at all times, camera-monitored, and protected by intrusion alarm. No other personnel permitted entry. | Asset Management Policy | CEO |
| A.7.7                 | Clear desk and clear screen                  | ✅       | Clear desk/clear screen defined in Asset Management Policy §4 (Clear Desk & Clear Screen); screen auto-lock, secure storage, remote-workspace rules; enforced via awareness and periodic spot checks. | Asset Management Policy          | Managing Director    |
...
| A.7.11 | Supporting utilities | ✅ | Home office utilities (power, connectivity) support NAS and Dev Server operations. Power interruption risk identified in IR-2026-001 (Mar 2026) and treated in RA-2026-001; a UPS was installed June 2026, providing power continuity for critical backup infrastructure (Risk #42 closed). Hetzner data center utilities (power, cooling, fire) managed under SLA, reviewed annually. | Asset Management Policy, Supplier Security & Contractual Obligations, RA-2026-001 | CEO / Managing Director |
...
| A.8.1                 | User endpoint devices                                   | ✅       | Company-managed, full-disk-encrypted devices; personal/BYOD devices not permitted for Confidential/Restricted data; VPN-only access. Defined in Asset Management Policy §4 (Mobile & Endpoint Device Security). | Asset Management Policy, Access Control Policy              | Team Lead Developer                |
...
| A.8.5 | Secure authentication | ✅ | MFA is mandatory for access to systems processing health-related personal data. Where a system cannot support native MFA (the CMS), a documented compensating control applies — static IP whitelisting restricting access to known endpoints — assessed and risk-accepted (Risk #28). | Risk #28 | Team Lead Developer | 
...
| A.8.23 | Web filtering | ✅ | Malicious/inappropriate-site filtering applied at endpoint level via managed devices and antivirus; VPN enforced for remote access. Home-office model — no building/ISP-level filtering. | Access Control Policy, Asset Management Policy | Team Lead Developer |
| A.8.24                | Use of cryptography                                     | ✅       | TLS in transit, encryption at rest and for backups, full-disk encryption, HTTPS-only, LastPass for secrets, TLS/SSL certificate lifecycle monitoring. Defined in Asset Management Policy §4 (Use of Cryptography & Key Management). | Access Control Policy, BCDR Plan                             | Team Lead Developer                |
| A.8.25 | Assessment of technical vulnerabilities | ✅ | Covered by automated threat monitoring using CrowdSec and an annual full vulnerability scan. Findings are reviewed and logged. | Secure Development & Change Management | Team Lead Developer |
...
### **3. NEN 7510-1:2024 — Zorgspecifieke beheersmaatregelen (Verklaring van Toepasselijkheid)**
...
> - **Alle 93 gedeelde beheersmaatregelen** (A.5.1–A.8.34) zijn volledig beoordeeld in de **ISO 27001:2022-VvT hierboven**; die beoordeling geldt eveneens voor NEN 7510 en wordt hier niet herhaald.
> - De **14 hieronder vermelde gedeelde beheersmaatregelen** worden herhaald omdat NEN 7510-2 er een **zorgspecifieke (aanvullende) maatregel** aan toevoegt.
> - De **8 HLT-beheersmaatregelen** (5.38–5.43, 6.9, 8.35) zijn **zorgspecifiek en uniek voor NEN 7510** (bestaan niet in ISO 27001).
> De volledige maatregelteksten zijn overgenomen uit NEN 7510-2:2024+A1:2026 (in licentie verstrekt aan DineRate B.V.).

| ID | Titel | Beschrijving (volledige maatregeltekst — NEN 7510-2:2024+A1:2026) | Van toepassing | Geïmplementeerd | Rechtvaardiging opname / uitsluiting | Uitbesteed (deels) | Gerelateerd beleid / proces |
|----|-------|------------------------------------------------------------------|----------------|-----------------|--------------------------------------|--------------------|-----------------------------|
| | **Gedeelde beheersmaatregelen met zorgdimensie (aanvullend op ISO 27001)** | | | | | | |
| A.5.1 | Beleidsregels voor informatiebeveiliging | Beheersmaatregel: Informatiebeveiligingsbeleid en onderwerpspecifieke beleidsregels behoren te worden gedefinieerd, goedgekeurd door het management, gepubliceerd, gecommuniceerd aan en erkend door relevant personeel en relevante belanghebbenden en met geplande tussenpozen en als zich significante wijzigingen voordoen, te worden beoordeeld.<br>**Zorgspecifiek (aanvullend):** Het informatiebeveiligingsbeleid behoort de aanpak voor het beheer van informatiebeveiliging te beschrijven en te zijn goedgekeurd door het topmanagement, vervolgens ten minste eenmaal per jaar en daarna telkens als er zich een ernstige beveiligingsgebeurtenis voordoet te worden beoordeeld. | Ja | Ja | ISMS-informatiebeveiligingsbeleid van toepassing; adresseert bescherming van gezondheidsgegevens; verwijst naar Wkkgz, Wabvpz, NEN 7510-1:2024. | Nee | Information Security Policy |
| A.5.2 | Rollen en verantwoordelijkheden bij informatiebeveiliging | Beheersmaatregel: Rollen en verantwoordelijkheden bij informatiebeveiliging behoren te worden gedefinieerd en toegewezen overeenkomstig de behoeften van de organisatie.<br>**Zorgspecifiek (aanvullend):** Er behoort ten minste één persoon verantwoordelijk te zijn voor informatiebeveiliging. | Ja | Ja | Rollen vastgelegd in ISMS-handboek §4; verantwoordelijkheid gezondheidsgegevens bij ISO Lead, eindverantwoordelijkheid CEO. | Nee | Information Security Policy; Access Control Policy; BCDR Plan; Incident Management Plan |
| A.5.9 | Inventarisatie van informatie en andere gerelateerde bedrijfsmiddelen | Beheersmaatregel: Er behoort een inventarislijst van informatie en andere gerelateerde bedrijfsmiddelen, met inbegrip van de eigenaren, te worden opgesteld en onderhouden.<br>**Zorgspecifiek (aanvullend):** Alle informatiestromen (zowel binnen als tussen organisaties) en de interfaces daarvan (waaronder integratieplatforms) behoren te worden opgenomen in de inventarisatie. | Ja | Ja | Bedrijfsmiddeleninventaris bijgehouden; gezondheidsgegevens apart geïdentificeerd en geclassificeerd als bijzondere persoonsgegevens. | Nee | Asset Management Policy |
| A.5.11 | Retourneren van bedrijfsmiddelen | Beheersmaatregel: Personeel en andere belanghebbenden, al naargelang de situatie, behoren alle bedrijfsmiddelen van de organisatie die ze in hun bezit hebben bij beëindiging van hun dienstverband, contract of overeenkomst te retourneren.<br>**Zorgspecifiek (aanvullend):** Er behoort beleid te zijn dat vereist dat personen schriftelijk bevestigen dat alle bedrijfsmiddelen in hun bezit in alle formaten op veilige wijze zijn geretourneerd of verwijderd, indien van toepassing. | Ja | Ja | Device-offboardingchecklist dekt teruggave; borgt dat geen gezondheidsgegevens achterblijven. | Nee | Asset Management Policy; Device Offboarding Checklist |
| A.5.12 | Classificeren van informatie | Beheersmaatregel: Informatie behoort te worden geclassificeerd volgens de informatiebeveiligingsbehoeften van de organisatie, op basis van de eisen voor vertrouwelijkheid, integriteit, beschikbaarheid en relevante eisen van belanghebbenden.<br>**Zorgspecifiek (aanvullend):** Persoonlijke gezondheidsinformatie behoort uniform als vertrouwelijk te worden geclassificeerd. | Ja | Ja | Gezondheidsgegevens in hoogste gevoeligheidsniveau met zwaarste beheersmaatregelen. | Nee | Asset Management Policy; Information Labelling Procedure |
| A.5.14 | Overdragen van informatie | Beheersmaatregel: Er behoren regels, procedures of overeenkomsten voor informatieoverdracht te zijn vastgesteld voor alle soorten van overdracht binnen de organisatie en tussen de organisatie en andere partijen.<br>**Zorgspecifiek (aanvullend):** Vóórdat enige overdracht plaatsvindt, behoren er regels, procedures en overeenkomsten te zijn ingesteld. | Ja | Ja | Beveiligde overdracht via TLS/VPN; gezondheidsgegevens versleuteld in transit, beperkt tot geautoriseerde zorgklant-tenants. | Ja (deels): transport via cloudproviders (Hetzner, Google) onder gedeelde verantwoordelijkheid | Asset Management Policy §4.4 (Information Transfer); Access Control Policy |
| A.5.15 | Toegangsbeveiliging | Beheersmaatregel: Er behoren regels op basis van bedrijfs- en informatiebeveiligingseisen te worden vastgesteld en geïmplementeerd om de fysieke en logische toegang tot informatie en andere gerelateerde bedrijfsmiddelen te beheersen.<br>**Zorgspecifiek (aanvullend):** Er behoort passend beleid voor op rollen gebaseerde toegangsbeveiliging te gelden voor de toegang tot persoonlijke gezondheidsinformatie. | Ja | Ja | Rolgebaseerde toegangsbeveiliging; toegang tot gezondheidsgegevens strikt op need-to-know per zorgklant-tenant. | Nee | Access Control Policy |
| A.5.16 | Identiteitsbeheer | Beheersmaatregel: De volledige levenscyclus van identiteiten behoort te worden beheerd.<br>**Zorgspecifiek (aanvullend):** Gebruikers die toegang willen hebben tot persoonlijke gezondheidsinformatie en andere vertrouwelijke informatie, behoren formeel te zijn geregistreerd. | Ja | Ja | Unieke identiteit per gebruiker; toegang tot gezondheidsgegevens uitsluitend via geauthenticeerde, geautoriseerde identiteiten. | Nee | Access Control Policy |
| A.5.19 | Informatiebeveiliging in leveranciersrelaties | Beheersmaatregel: Er behoren processen en procedures te worden vastgesteld en geïmplementeerd om de informatiebeveiligingsrisico's in verband met het gebruik van producten of diensten van de leverancier te beheersen.<br>**Zorgspecifiek (aanvullend):** De risico's in verband met toegang door externe partijen tot systemen of de gegevens die zij bevatten behoren te worden beoordeeld en beheersmaatregelen passend bij het geïdentificeerde risico behoren te worden geïmplementeerd. | Ja | Ja | Sub-verwerkers van gezondheidsgegevens (Hetzner) gebonden aan DPA met zorg-specifieke eisen. | Ja (deels): Hetzner als sub-verwerker (hosting/opslag gezondheidsgegevens) onder DPA | Supplier Security & Contractual Obligations |
| A.6.2 | Arbeidsovereenkomst | Beheersmaatregel: In arbeidsovereenkomsten behoort te worden vermeld wat de verantwoordelijkheden van het personeel en van de organisatie zijn wat betreft informatiebeveiliging.<br>**Zorgspecifiek (aanvullend):** In functiebeschrijvingen behoren de beveiligingsrollen en verantwoordelijkheden te worden vermeld die van toepassing zijn op het verwerken van persoonlijke gezondheidsinformatie. | Ja | Ja | Arbeidsovereenkomsten bevatten geheimhouding; medewerkers met toegang tot gezondheidsgegevens gebonden aan medisch beroepsgeheim. | Nee | Access Control Policy; Employment/HR agreements |
| A.6.6 | Vertrouwelijkheids- of geheimhoudingsovereenkomsten | Beheersmaatregel: Vertrouwelijkheids- of geheimhoudingsovereenkomsten die de behoeften van de organisatie inzake de bescherming van informatie weerspiegelen, behoren te worden geïdentificeerd, gedocumenteerd, regelmatig te worden beoordeeld en ondertekend door personeel en andere relevante belanghebbenden.<br>**Zorgspecifiek (aanvullend):** Alle personeel dat bevoegd is tot toegang tot persoonlijke gezondheidsinformatie behoort er formeel toe te worden verplicht die informatie vertrouwelijk te behandelen. | Ja | Ja | Geheimhoudingsovereenkomsten dekken expliciet gezondheidsgegevens en medisch geheim. | Nee | Access Control Policy; NDAs / Confidentiality agreements |
| A.7.10 | Opslagmedia | Beheersmaatregel: Opslagmedia behoren te worden beheerd gedurende hun volledige levenscyclus van aanschaf, gebruik, transport en verwijdering overeenkomstig het classificatieschema en de hanteringseisen van de organisatie.<br>**Zorgspecifiek (aanvullend):** Alle persoonlijke gezondheidsinformatie die op verwijderbare media wordt opgeslagen, behoort te worden versleuteld. | Ja | Ja | Verwijderbare media verboden en technisch afgedwongen; media met gezondheidsgegevens versleuteld en veilig gewist vóór afvoer/hergebruik. | Nee | Asset Management Policy; Access Control Policy |
| A.8.5 | Beveiligde authenticatie | Beheersmaatregel: Er behoren beveiligde authenticatietechnologieën en -procedures te worden geïmplementeerd op basis van beperkingen van de toegang tot informatie en het onderwerpspecifieke beleid inzake toegangsbeveiliging.<br>**Zorgspecifiek (aanvullend):** Er behoort ten minste twee-factorauthenticatie te worden gebruikt voor systemen die persoonlijke gezondheidsinformatie verwerken. | Ja | Ja | MFA verplicht voor systemen met gezondheidsgegevens; waar native MFA ontbreekt (CMS) geldt IP-whitelisting als gedocumenteerde, risico-geaccepteerde compenserende maatregel (Risico #28). | Nee | Access Control Policy §MFA; Risico #28 (compenserende maatregel) |
| A.8.13 | Back-up van informatie | Beheersmaatregel: Back-ups van informatie, software en systemen behoren te worden bewaard en regelmatig te worden getest overeenkomstig het overeengekomen onderwerpspecifieke beleid inzake back-ups.<br>**Zorgspecifiek (aanvullend):** Back-ups van persoonlijke gezondheidsinformatie behoren te worden versleuteld. | Ja | Ja | Back-ups versleuteld, bewaard conform wettelijke eisen, herstelbaar binnen 4-uurs RTO; maandelijkse hersteltests. | Ja (deels): back-upinfrastructuur bij Hetzner (productie) en Azure (failover); beheer/hersteltests door Rate | BCDR Plan §5 (Backup and Recovery Procedures) |
| | **HLT — Zorgspecifieke beheersmaatregelen (uniek voor NEN 7510)** | | | | | | |
| A.5.38 | HLT – Analyse en specificatie van informatiebeveiligingseisen | Zorgspecifieke beheersmaatregel: De informatiebeveiligingsgerelateerde eisen behoren te worden opgenomen in de eisen voor nieuwe informatiesystemen of verbeteringen aan bestaande informatiesystemen. | Ja | Ja | Beveiligingseisen voor gezondheidsgegevens in de ontwerpfase gespecificeerd voor alle functionaliteit die patiëntfeedback verwerkt. | Nee | Secure Development & Change Management |
| A.5.39 | HLT – Zorgontvangers op unieke wijze identificeren | Zorgspecifieke beheersmaatregel: Beleid en processen behoren te waarborgen dat elke zorgontvanger op unieke wijze binnen het systeem kan worden geïdentificeerd en behoren in staat te zijn dubbele of meervoudige registraties samen te voegen als er dubbele of meervoudige registraties zijn voor een en dezelfde zorgontvanger. | Ja | Gedeeltelijk | Bewuste scope-afbakening. Rate is een feedbackplatform: feedback wordt betrouwbaar toegewezen aan de indienende respondent; unieke klinische patiëntidentificatie is de verantwoordelijkheid van de zorgklant als verwerkingsverantwoordelijke. Vastgelegd in BOZ-addendum en algemene voorwaarden (IMP-2026-NEN-01, gesloten). | Nee — klinische identificatie is verantwoordelijkheid van de zorgaanbieder (verwerkingsverantwoordelijke) | Access Control Policy; BOZ-addendum & algemene voorwaarden (IMP-2026-NEN-01) |
| A.5.40 | HLT – Validatie van getoonde/geprinte gegevens | Zorgspecifieke beheersmaatregel: Als er gegevens worden getoond en/of geprint door gezondheidsinformatiesystemen behoren deze gegevens ook informatie te omvatten waarmee de zorgontvanger waarop de gegevens betrekking heeft wordt geïdentificeerd. | Ja | Ja | Integriteitscontroles borgen dat weergegeven/geëxporteerde feedback overeenkomt met opgeslagen gegevens zonder wijziging. | Nee | Secure Development & Change Management |
| A.5.41 | HLT – Openbaar beschikbare gezondheidsinformatie | Zorgspecifieke beheersmaatregel: Openbaar beschikbare gezondheidsinformatie behoort te worden beschermd, bewaard en beheerd gedurende de volledige levenscyclus. | Ja | Ja | Rate publiceert geen gezondheidsgegevens openbaar; uitsluitend volledig geanonimiseerde statistische gegevens in geaggregeerde rapportage. | Nee | Information Security Policy; Asset Management Policy |
| A.5.42 | HLT – Communicatie in noodsituaties | Zorgspecifieke beheersmaatregel: Noodcommunicatiekanalen binnen een zorgorganisatie die in werking treden wanneer er een storing is in de continuïteit van de ICT van de organisatie behoren te worden gepland, geïmplementeerd, onderhouden en beproefd. | Ja | Ja | Bij een groot incident dat de beschikbaarheid van gezondheidsgegevens raakt, worden zorgklanten direct geïnformeerd om continuïteit van zorg te behouden. | Nee | BCDR Plan; Incident Management & Response Plan |
| A.5.43 | HLT – Incidenten extern melden | Zorgspecifieke beheersmaatregel: Informatiebeveiligingsincidenten behoren volgens juridische of contractuele verplichtingen of verplichtingen uit hoofde van wet- en regelgeving te worden gemeld. | Ja | Ja | Rate (verwerker) informeert zorgklanten (verwerkingsverantwoordelijken); klanten verzorgen externe melding aan autoriteiten. Rate ondersteunt binnen de AVG-termijn van 72 uur. Verantwoordelijkheid vastgelegd in BOZ-addendum (IMP-2026-NEN-01). | Deels: externe melding aan autoriteiten door zorgaanbieder (verwerkingsverantwoordelijke); Rate ondersteunt | Incident Management & Response Plan; BOZ-addendum (IMP-2026-NEN-01) |
| A.6.9 | HLT – Managementtraining | Zorgspecifieke beheersmaatregel: Het management van de organisatie behoort passende training te krijgen, naarmate relevant is voor hun rollen en verantwoordelijkheden met betrekking tot informatiebeveiliging en hoe het wordt beheerd. | Ja | Ja | Jaarlijkse security-awarenesstraining; CEO getraind over verplichtingen inzake gezondheidsinformatiebeveiliging en NEN 7510-verantwoordelijkheden. | Nee | Information Security Policy; Training & Awareness (Logs §1) |
| A.8.35 | HLT – Zero trust-beginselen | Zorgspecifieke beheersmaatregel: Aan een netwerksegment toegewezen groepen informatiediensten, gebruikers en informatiesystemen behoren zo klein mogelijk te worden gehouden en behoren slechts toegang tot een ander netwerksegment te hebben nadat beide betrokken segmenten elkaar hebben geauthentiseerd. | Ja | Gedeeltelijk | Rate past diverse zero-trust-principes toe (RBAC least-privilege, VPN-geverifieerde toegang, IP-whitelisting, dev/prod-scheiding, CrowdSec-monitoring). Een volledige, formele zero-trust-architectuur is niet geïmplementeerd; acceptabel omdat dit geen certificeringseis van NEN 7510 is. | Nee | Access Control Policy; Netwerkbeveiliging (A.8.20–A.8.22) |

### **3a. NEN 7510-1:2024 — Healthcare-Specific Controls (Statement of Applicability) — English**
...
> - **All 93 shared controls** (A.5.1–A.8.34) are fully assessed in the **ISO 27001:2022 SoA above**; that assessment applies equally to NEN 7510 and is not repeated here.
> - The **14 shared controls below** are repeated because NEN 7510-2 adds a **healthcare-specific (additional) measure** to each.
> - The **8 HLT controls** (5.38–5.43, 6.9, 8.35) are **health-specific and unique to NEN 7510** (not present in ISO 27001).
> The control texts are taken from NEN 7510-2:2024+A1:2026 (licensed to DineRate B.V.). The English wording below is a working translation for readability; the authoritative text is the licensed Dutch standard.

| ID | Title | Description (full control text — NEN 7510-2:2024+A1:2026) | Applicable | Implemented | Reason for inclusion / exclusion | Outsourced (partly) | Related policy / process |
|----|-------|-----------------------------------------------------------|------------|-------------|----------------------------------|---------------------|--------------------------|
| | **Shared controls with a healthcare dimension (additional to ISO 27001)** | | | | | | |
| A.5.1 | Information security policies | Control: Information security policy and topic-specific policies should be defined, approved by management, published, communicated to and acknowledged by relevant personnel and relevant interested parties, and reviewed at planned intervals and if significant changes occur.<br>**Healthcare-specific (additional):** The information security policy should describe the approach to managing information security and be approved by top management, then reviewed at least once a year and thereafter whenever a serious security event occurs. | Yes | Yes | ISMS Information Security Policy applies; addresses health-data protection; references Wkkgz, Wabvpz, NEN 7510-1:2024. | No | Information Security Policy |
| A.5.2 | Information security roles and responsibilities | Control: Information security roles and responsibilities should be defined and allocated according to the organization's needs.<br>**Healthcare-specific (additional):** At least one person should be responsible for information security. | Yes | Yes | Roles defined in ISMS Manual §4; health-data responsibility with ISO Lead, accountability with CEO. | No | Information Security Policy; Access Control Policy; BCDR Plan; Incident Management Plan |
| A.5.9 | Inventory of information and other associated assets | Control: An inventory of information and other associated assets, including owners, should be developed and maintained.<br>**Healthcare-specific (additional):** All information flows (within and between organizations) and their interfaces (including integration platforms) should be included in the inventory. | Yes | Yes | Asset inventory maintained; health data identified separately and classified as special-category data. | No | Asset Management Policy |
| A.5.11 | Return of assets | Control: Personnel and other interested parties, as appropriate, should return all of the organization's assets in their possession upon termination of their employment, contract or agreement.<br>**Healthcare-specific (additional):** A policy should require individuals to confirm in writing that all assets in their possession, in all formats, have been securely returned or disposed of, where applicable. | Yes | Yes | Device Offboarding Checklist covers return; ensures no health data remains. | No | Asset Management Policy; Device Offboarding Checklist |
| A.5.12 | Classification of information | Control: Information should be classified according to the organization's information security needs, based on requirements for confidentiality, integrity, availability and relevant interested-party requirements.<br>**Healthcare-specific (additional):** Personal health information should be uniformly classified as confidential. | Yes | Yes | Health data at highest sensitivity tier with strongest controls. | No | Asset Management Policy; Information Labelling Procedure |
| A.5.14 | Information transfer | Control: Rules, procedures or agreements for information transfer should be established for all types of transfer within the organization and between the organization and other parties.<br>**Healthcare-specific (additional):** Before any transfer takes place, rules, procedures and agreements should be established. | Yes | Yes | Secure transfer via TLS/VPN; health data encrypted in transit, restricted to authorized healthcare-customer tenants. | Yes (partly): transfer via cloud providers (Hetzner, Google) under shared responsibility | Asset Management Policy §4.4 (Information Transfer); Access Control Policy |
| A.5.15 | Access control | Control: Rules based on business and information security requirements should be established and implemented to control physical and logical access to information and other associated assets.<br>**Healthcare-specific (additional):** Appropriate role-based access control policy should apply to access to personal health information. | Yes | Yes | Role-based access control; health-data access strictly need-to-know per healthcare-customer tenant. | No | Access Control Policy |
| A.5.16 | Identity management | Control: The full lifecycle of identities should be managed.<br>**Healthcare-specific (additional):** Users who wish to access personal health information and other confidential information should be formally registered. | Yes | Yes | Unique identity per user; health-data access only via authenticated, authorized identities. | No | Access Control Policy |
| A.5.19 | Information security in supplier relationships | Control: Processes and procedures should be established and implemented to manage the information security risks associated with the use of the supplier's products or services.<br>**Healthcare-specific (additional):** The risks associated with external-party access to systems or the data they contain should be assessed, and controls appropriate to the identified risk implemented. | Yes | Yes | Sub-processors of health data (Hetzner) bound by DPA with healthcare-grade requirements. | Yes (partly): Hetzner as sub-processor (hosting/storage of health data) under DPA | Supplier Security & Contractual Obligations |
| A.6.2 | Terms and conditions of employment | Control: Employment contracts should state the responsibilities of personnel and of the organization regarding information security.<br>**Healthcare-specific (additional):** Job descriptions should state the security roles and responsibilities applicable to processing personal health information. | Yes | Yes | Employment contracts include confidentiality; staff with health-data access bound to medical confidentiality. | No | Access Control Policy; Employment/HR agreements |
| A.6.6 | Confidentiality or non-disclosure agreements | Control: Confidentiality or non-disclosure agreements reflecting the organization's needs for the protection of information should be identified, documented, regularly reviewed and signed by personnel and other relevant interested parties.<br>**Healthcare-specific (additional):** All personnel authorized to access personal health information should be formally required to treat that information confidentially. | Yes | Yes | NDAs explicitly cover health data and medical secrecy. | No | Access Control Policy; NDAs / Confidentiality agreements |
| A.7.10 | Storage media | Control: Storage media should be managed throughout their full lifecycle of acquisition, use, transport and disposal in accordance with the organization's classification scheme and handling requirements.<br>**Healthcare-specific (additional):** All personal health information stored on removable media should be encrypted. | Yes | Yes | Removable media prohibited and technically enforced; media with health data encrypted and securely wiped before disposal/reuse. | No | Asset Management Policy; Access Control Policy |
| A.8.5 | Secure authentication | Control: Secure authentication technologies and procedures should be implemented based on restrictions on access to information and the topic-specific access control policy.<br>**Healthcare-specific (additional):** At least two-factor authentication should be used for systems processing personal health information. | Yes | Yes | MFA mandatory for systems with health data; where native MFA is unsupported (CMS), IP whitelisting applies as a documented, risk-accepted compensating control (Risk #28). | No | Access Control Policy §MFA; Risk #28 (compensating control) |
| A.8.13 | Information backup | Control: Backups of information, software and systems should be retained and regularly tested in accordance with the agreed topic-specific backup policy.<br>**Healthcare-specific (additional):** Backups of personal health information should be encrypted. | Yes | Yes | Backups encrypted, retained per legal requirements, recoverable within 4-hour RTO; monthly restore tests. | Yes (partly): backup infrastructure at Hetzner (production) and Azure (failover); management/restore tests by Rate | BCDR Plan §5 (Backup and Recovery Procedures) |
| | **HLT — Healthcare-specific controls (unique to NEN 7510)** | | | | | | |
| A.5.38 | HLT – Analysis and specification of information security requirements | Healthcare-specific control: Information security-related requirements should be included in the requirements for new information systems or enhancements to existing information systems. | Yes | Yes | Health-data security requirements specified at design stage for all features processing patient feedback. | No | Secure Development & Change Management |
| A.5.39 | HLT – Unique identification of care recipients | Healthcare-specific control: Policies and processes should ensure that each care recipient can be uniquely identified within the system, and should be able to merge duplicate or multiple records where these exist for one and the same care recipient. | Yes | Partial | Deliberate scope boundary. Rate is a feedback platform: feedback is reliably attributed to the submitting respondent; unique clinical patient identification is the healthcare customer's responsibility as data controller. Formalized in the BOZ addendum and General Terms (IMP-2026-NEN-01, closed). | No — clinical identification is the healthcare provider's responsibility (data controller) | Access Control Policy; BOZ addendum & General Terms (IMP-2026-NEN-01) |
| A.5.40 | HLT – Validation of displayed/printed data | Healthcare-specific control: When data is displayed and/or printed by health information systems, that data should also include information identifying the care recipient to whom the data relates. | Yes | Yes | Integrity controls ensure displayed/exported feedback matches stored data without alteration. | No | Secure Development & Change Management |
| A.5.41 | HLT – Publicly available health information | Healthcare-specific control: Publicly available health information should be protected, retained and managed throughout its full lifecycle. | Yes | Yes | Rate publishes no health data publicly; only fully anonymized statistical data in aggregate reporting. | No | Information Security Policy; Asset Management Policy |
| A.5.42 | HLT – Communication in emergency situations | Healthcare-specific control: Emergency communication channels within a healthcare organization that come into operation when there is a disruption to the continuity of the organization's ICT should be planned, implemented, maintained and tested. | Yes | Yes | For a major incident affecting health-data availability, healthcare customers are notified promptly to maintain continuity of care. | No | BCDR Plan; Incident Management & Response Plan |
| A.5.43 | HLT – External incident reporting | Healthcare-specific control: Information security incidents should be reported in accordance with legal, contractual or regulatory obligations. | Yes | Yes | Rate (processor) notifies healthcare customers (controllers); customers handle external reporting to authorities. Rate supports within the GDPR 72-hour timeframe. Responsibility defined in BOZ addendum (IMP-2026-NEN-01). | Partly: external reporting to authorities by the healthcare provider (data controller); Rate supports | Incident Management & Response Plan; BOZ addendum (IMP-2026-NEN-01) |
| A.6.9 | HLT – Management training | Healthcare-specific control: The organization's management should receive appropriate training, as relevant to their roles and responsibilities regarding information security and how it is managed. | Yes | Yes | Annual security-awareness training; CEO trained on health information-security obligations and NEN 7510 responsibilities. | No | Information Security Policy; Training & Awareness (Logs §1) |
| A.8.35 | HLT – Zero trust principles | Healthcare-specific control: Groups of information services, users and information systems assigned to a network segment should be kept as small as possible and should only access another network segment after both segments involved have authenticated each other. | Yes | Partial | Rate applies several zero-trust principles (RBAC least-privilege, VPN-verified access, IP whitelisting, dev/prod separation, CrowdSec monitoring). A full formal zero-trust architecture is not implemented; acceptable as it is not a NEN 7510 certification requirement. | No | Access Control Policy; Network security (A.8.20–A.8.22) |
...
| NC-2025-EXT-04 | NC (Minor) | 10.2 | Nonconformity | Corrective Action Log lacked root cause analysis for NCs from internal audit. | The log template did not include a mandatory root cause analysis field. Entries were recorded as findings only, without structured cause investigation. This meant corrective actions addressed symptoms rather than underlying causes, reducing ISMS improvement effectiveness. | Corrective Actions Log template and all existing entries | Updated log format to include mandatory Root Cause Analysis column. All existing NC entries (NC-2025-EXT-01 through OBS-2025-EXT-01) backfilled with root cause analysis. New entries going forward require root cause analysis before status can be set to Closed. | Log format revised to require root cause analysis for all entries. Backfilling completed for all prior NCs. Evidence: this log entry and all sibling entries now contain root cause analysis fields. Separate RCA document created — see [Root Cause Analysis — NC-2025-EXT-04 — Corrective Actions Log Format](https://docs.google.com/document/d/1jZR6aE70loqv5tzNZ6kUHe5J8eKR99150bWSxwzQWxM). | 15 Sept 2025 | Firas | ✅ Closed |
...
| ID | Finding type | Norm element | Anomaly type | Description of deviation | Root cause analysis | Scope of analysis | Recovery on the deviation (direct recovery) | Corrective action of the root cause | Corrective Action Taken | Responsible | Status |
|----|--------------|--------------|--------------|--------------------------|---------------------|-------------------|---------------------------------------------|-------------------------------------|-------------------------|-------------|--------|
| IMP-2026-NEN-01 | Improvement Point | NEN 7510 A.5.39 / A.5.43 | OFI | Customer DPAs should explicitly state that unique patient identification (A.5.39) and external authority incident reporting (A.5.43) are the responsibility of the healthcare customer as data controller. | DPAs did not yet reflect the NEN 7510 role split between processor (Rate) and controller (customer). | Customer contracts & DPAs | Note added to SoA justifications referencing customer DPA responsibility. | Update customer DPA template to clarify that Rate acts as data processor; unique patient identification and external authority reporting (Autoriteit Persoonsgegevens, IGJ) remain the customer's responsibility as data controller. | Completed. CEO updated the General Terms & Conditions to reference client responsibilities and the data processing agreement. The BOZ addendum now explicitly defines controller/processor responsibilities including client identification (A.5.39), data breach notification (A.5.43), and application of AVG/GDPR and NEN 7510. Updated terms apply to new customers and are shared with existing customers at renewal under silent prolongation. [Confirmed by CEO email 2026-06-12](https://drive.google.com/file/d/1OK47anPDLmBFp_3RwPpJ_7uEprfL8P3A/view?usp=drive_link). | Managing Director | ✅ Closed |
...
| ID | Finding type | Norm element | Anomaly type | Description of deviation | Root cause analysis | Scope of analysis | Recovery on the deviation (direct) | Corrective Action Taken | Responsible | Status |
|----|--------------|--------------|--------------|--------------------------|---------------------|-------------------|------------------------------------|-------------------------|-------------|--------|
| NB-2026-01 | NC (Major) | A.5.19–A.5.22 | Nonconformity | No formal supplier assessment process, supplier register with security classification, or documented minimum security requirements per supplier type. Supplier agreements existed but were not reviewed through a structured security lens. | The standardized Supplier Security Assessment process was introduced only in June 2026, and at audit time only the pilot supplier (Hetzner) had been assessed. Supplier risk had previously been captured only implicitly in the risk register (#29–38) rather than through a dedicated, repeatable assessment procedure. | Supplier Security section, Supplier Assessment Log, all active supplier relationships | Completed a Supplier Security Assessment Form for all 10 active suppliers (data-access scope, certifications, DPA status, technical controls, risk rating, approval decision). | Formalized the supplier register + Supplier Assessment Log (10 suppliers, risk-rated); embedded annual supplier assessment in the ISMS Audit Calendar; documented per-supplier responsibilities. 10 signed forms in the ISMS evidence folder; LastPass rated Medium / Approved-with-conditions; Annual Supplier Security Review MoM (2026-07-15) completed. | Firas Kassoumeh | ✅ Closed  |
| NC-2026-01 | NC (Minor) | 4.2 | Nonconformity | Interested-parties register did not consistently indicate whether identified requirements are actively addressed/monitored (report also cited climate change and a "security company" — both already resolved). | The register was built as a static needs list; the template focused on identifying parties, not tracking ongoing fulfilment, so no monitoring field existed. | Interested Parties register (Section 1) | Added a "How Addressed / Monitored" column mapping each stakeholder's needs to the controls/reviews that fulfil them. | Interested-parties table updated with the monitoring column. Climate change already covered (Issue #11 / Risk #41 / NC-2025-EXT-01, closed 19 Sept 2025); obsolete "security company" party already replaced with "Home-Office Physical Security (CEO)". | Firas Kassoumeh | ✅ Closed  |
| NC-2026-02 | NC (Minor) | 7.2 | Nonconformity | Retained evidence of competence does not demonstrate the organization's own stated competence requirements; independent-review role lacked defined competence requirements. | Competence requirements were defined narratively per role, but the ISMS never required objective evidence (CVs, certificates, training mapped to competencies) to be retained; the independent-review role had no competence profile. | Competence (Info Security Policy §4) | Added an "Evidence of Competence (Clause 7.2)" clause requiring competence evidence to be retained and reviewed. | Info Security Policy §4.5 now requires CVs, certifications, and training records mapped to each role's competencies, retained in HR records and reviewed annually; the external reviewer's qualifications are defined via the Independent ISMS Review Terms of Reference (§4.6). | Firas Kassoumeh | ✅ Closed  |
| NC-2026-03 | NC (Minor) | A.5.13 | Nonconformity | A labelling procedure is developed but not implemented; classification not applied as information labelling per the adopted scheme. | A 4-tier classification scheme existed but no operational labelling procedure was implemented — the SoA relied on access controls as a proxy for labelling, which does not satisfy A.5.13. | Asset Management Policy, SoA A.5.13, ISMS evidence documents | Implemented an Information Labelling Procedure (tier → marking → handling) in the Asset Management Policy; corrected the SoA A.5.13 justification. | Key ISMS documents labelled Confidential/Restricted (Asset Inventory, incident report, supplier forms, access review, management review minutes) and recorded in the Information Labelling Register (Logs §17). | Firas Kassoumeh | ✅ Closed  |
| NC-2026-04 | NC (Minor) | A.5.35 | Nonconformity | The independent-review compensating control ("external security officer") was referenced but not formally defined in terms of frequency, scope, or qualifications. | The control was introduced in the Segregation-of-Duties statement at concept level only and conflated a non-existent "security officer" role with the independent audit; its terms of reference were never formalized. | Governance (Segregation of Duties §4.6), Independent Review | Reframed the control honestly: the independent review is the annual ISMS audit performed by an external party (Jaguar IT), not a separate officer. | Added an "Independent ISMS Review — Terms of Reference" (§4.6) defining scope, at-least-annual frequency, provider (Jaguar IT / Steven Vogelaar), and independence; removed the phantom "security officer" so the compensating controls are now three real ones (CEO approval, independent external audit, privileged-action logging); SoA A.5.35 updated. | Firas Kassoumeh | ✅ Closed  |
| NC-2026-05 | NC (Minor) | NEN 7510 A.8.5 | Nonconformity | MFA phrasing was read as "recommended" rather than mandatory for privileged access to systems processing health data. | The Access Control Policy already mandated MFA (§5), but the SoA/NEN A.8.5 wording did not clearly document that the CMS (no native MFA, processes health data) relies on IP-whitelisting as a formal compensating control, creating ambiguity. | Access Control Policy §5, SoA/NEN A.8.5 | Confirmed MFA is stated as mandatory (§5) and clarified the NEN A.8.5 wording. | SoA/NEN A.8.5 updated to state MFA is mandatory for health-data systems, with the CMS IP-whitelisting compensating control documented as a risk-accepted exception (Risk #28). | Firas Kassoumeh | ✅ Closed  |

### Opportunities for Improvement (OFI) — Internal Audit 2026

| ID | Norm element | Description | Planned action | Responsible | Status |
|----|--------------|-------------|----------------|-------------|--------|
...
| Backup Integrity | Success rate of monthly backup restorations | ≥ 99% | Backups tested monthly with at least 99% success rate. Any failed restoration test must be investigated and a corrective action logged within 24 hours. Failures caused by infrastructure incidents (e.g., power outage) must be documented in the Incident Log. | Monthly |
...
| 2025-11-24 | Asset Inventory Check for Home Office Devices | Managing Director | Annual | ✅ Closed | CEO | [Asset Inventory](Logs.md#5-asset-inventory) ,  [Asset Inventory Check – Home Office Devices](https://docs.google.com/document/d/1Mbq44s1gVBIaUNoDwJXDqXn1HDv5_nUkUS806lTHGjc/edit?tab=t.0)|
...
| 2026-05-10 | Backup Restore Test | Team Lead Developer | Monthly | ✅ 2026-05-13 | Managing Director | [DB Restore Test Log](Logs.md#4-db-restore-test-log) |
| 2026-06-10 | Backup Restore Test | Team Lead Developer | Monthly | ✅ 2026-06-12 | Managing Director | [DB Restore Test Log](Logs.md#4-db-restore-test-log) |
| 2026-07-10 | Backup Restore Test | Team Lead Developer | Monthly | ✅ 2026-07-10 | Managing Director | [DB Restore Test Log](Logs.md#4-db-restore-test-log) |
| 2026-08-10 | Backup Restore Test | Team Lead Developer | Monthly | ✅ 2026-08-10 | Managing Director | [DB Restore Test Log](Logs.md#4-db-restore-test-log) |
| 2026-09-10 | Backup Restore Test | Team Lead Developer | Monthly | ✅ 2026-09-10 | Managing Director | [DB Restore Test Log](Logs.md#4-db-restore-test-log) |
...
| 2026-07-20 | CrowdSec Monitoring Log Review | Team Lead Developer | Annual | ✅ 2026-09-01 | Managing Director | [CrowdSec Monitoring Log](Logs.md#11-crowdsec-monitoring-log) |
...
| 2026-09-25 | Password Rotation — all admin and critical accounts | Managing Director / Team Lead Developer | Every 180 days | ✅ 2026-09-25 | Managing Director | [Password Rotation Log](Logs.md#15-password-rotation-log) |
...
> **2027 programme:** Recurring controls and reviews continue into 2027 as shown by the "Next Due" dates above. The full 2027 Annual Audit Calendar will be finalised at the post-Stage 2 management review, incorporating any Stage 2 findings, the DigiTrust surveillance schedule, and the NEN 7510 / ISO 27001 certification cycle.

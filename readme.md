...
| ID | Titel | Beschrijving (volledige maatregeltekst — NEN 7510-2:2024+A1:2026) | Van toepassing | Geïmplementeerd | Rechtvaardiging opname / uitsluiting | Uitbesteed (deels) |
|----|-------|------------------------------------------------------------------|----------------|-----------------|--------------------------------------|--------------------|
...
| A.5.11 | Retourneren van bedrijfsmiddelen | Beheersmaatregel: Personeel en andere belanghebbenden, al naargelang de situatie, behoren alle bedrijfsmiddelen van de organisatie die ze in hun bezit hebben bij beëindiging van hun dienstverband, contract of overeenkomst te retourneren.<br>**Zorgspecifiek (aanvullend):** Er behoort beleid te zijn dat vereist dat personen schriftelijk bevestigen dat alle bedrijfsmiddelen in hun bezit in alle formaten op veilige wijze zijn geretourneerd of verwijderd, indien van toepassing. | Ja | Ja | Device-offboardingchecklist dekt teruggave; borgt dat geen gezondheidsgegevens achterblijven. | Nee |
| A.5.12 | Classificeren van informatie | Beheersmaatregel: Informatie behoort te worden geclassificeerd volgens de informatiebeveiligingsbehoeften van de organisatie, op basis van de eisen voor vertrouwelijkheid, integriteit, beschikbaarheid en relevante eisen van belanghebbenden.<br>**Zorgspecifiek (aanvullend):** Persoonlijke gezondheidsinformatie behoort uniform als vertrouwelijk te worden geclassificeerd. | Ja | Ja | Gezondheidsgegevens in hoogste gevoeligheidsniveau met zwaarste beheersmaatregelen. | Nee |
...
| ID | Title | Description (full control text — NEN 7510-2:2024+A1:2026) | Applicable | Implemented | Reason for inclusion / exclusion | Outsourced (partly) |
|----|-------|-----------------------------------------------------------|------------|-------------|----------------------------------|---------------------|

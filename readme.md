...
> **External Security Officer — Terms of Reference (A.5.35):** The independent external security officer provides periodic independent review of the ISMS as a compensating control for limited segregation of duties. **Scope:** review of ISMS implementation, risk management, access controls, and corrective actions. **Frequency:** at least annually. **Qualifications:** demonstrable information-security expertise (e.g. ISO 27001 Lead Auditor/Implementer or equivalent experience) and independence from Rate's day-to-day operations. **Appointee:** Jaguar IT / Steven Vogelaar  — appointed and recorded in the ISMS Review & Approval Log. Findings are reported to the CEO and tracked in the Corrective Actions register.
...
| A.5.35                 | Independent review of information security                     | ✅       | Independent ISMS review is performed at least annually by an external security officer per the documented Terms of Reference (§4.6), alongside internal audits and external certification audits. | Internal Audit Procedure, Security Officer ToR, External Audit Reports | CEO |
...
| ID | Finding type | Norm element | Anomaly type | Description of deviation | Root cause analysis | Scope of analysis | Recovery on the deviation (direct recovery) | Corrective action of the root cause | Corrective Action Taken | Responsible | Status |
|----|--------------|--------------|--------------|--------------------------|---------------------|-------------------|---------------------------------------------|-------------------------------------|-------------------------|-------------|--------|
| NB-2026-01 | NC (Major) | A.5.19–A.5.22 | Nonconformity | No formal supplier assessment process, supplier register with security classification, or documented minimum security requirements per supplier type. Supplier agreements existed but were not reviewed through a structured security lens. | The standardized Supplier Security Assessment process was introduced only in June 2026, and at audit time only the pilot supplier (Hetzner) had been assessed. Supplier risk had previously been captured only implicitly in the risk register (#29–38) rather than through a dedicated, repeatable assessment procedure, so no full register with risk classification or per-supplier minimum requirements existed. | Supplier Security section, Supplier Assessment Log, all active supplier relationships | Completed a Supplier Security Assessment Form for all 10 active suppliers (Hetzner, Google Workspace, GitHub, LastPass, Exact Online, Freshdesk, Trello, Stack Overflow, Miro, CrowdSec) with data-access scope, certifications, DPA status, technical controls, risk rating, and approval decision. | Formalized the supplier register + Supplier Assessment Log (10 suppliers, risk-rated); embedded annual supplier assessment in the ISMS Audit Calendar; documented per-supplier security responsibilities. LastPass rated Medium / Approved-with-conditions with a tracked action to evaluate alternatives. Evidence: 10 signed assessment forms in the ISMS evidence folder + Annual Supplier Security Review MoM (2026-07-15). | Firas Kassoumeh | ✅ Closed (pending CEO verification) |
| NC-2026-01 | NC (Minor) | 4.2 | Nonconformity | Interested-parties register does not consistently indicate whether identified requirements are actively addressed/monitored. (Report also cited climate change and a listed "security company"; both already resolved — see notes.) | The interested-parties register was built as a static needs list; the template focused on identifying parties, not on tracking ongoing fulfilment, so no "addressed/monitored" status field was included. | Interested Parties register (Section 1) | Add a status/monitoring indicator to the interested-parties table. | Interested-parties table updated with an "How addressed / monitored" column per stakeholder. Note: climate change was already assessed (Issue #11 / Risk #41 / NC-2025-EXT-01, closed 19 Sept 2025) and the obsolete "security company" party was already replaced with "Home-Office Physical Security (CEO)". | Firas Kassoumeh | 🔄 In progress |
| NC-2026-02 | NC (Minor) | 7.2 | Nonconformity | Retained evidence of competence does not demonstrate the organization's own stated competence requirements (e.g. "proficiency in access control and DevSecOps"); external Security Officer role lacks defined competence requirements. | Competence requirements were defined narratively per role, but the ISMS never required objective evidence (CVs, certificates, training mapped to the stated competencies) to be retained; the external Security Officer role was added as a compensating control without a competence profile. | Competence (Info Security Policy §4), Security Officer role | Retain competence evidence for security roles. | (Planned) Add competence-evidence references (CVs, certifications, training records) held in HR records, mapped to each role's stated competencies; define the Security Officer competence profile. Target: within 6 months. | Firas Kassoumeh | 🔄 In progress |
| NC-2026-03 | NC (Minor) | A.5.13 | Nonconformity | A labelling procedure is developed but not implemented; classification is not applied as information labelling per the adopted scheme. | A 4-tier classification scheme exists, but no operational labelling procedure was implemented — the SoA relied on access controls/permissions as a proxy for labelling, which does not satisfy A.5.13's requirement to mark information according to the classification scheme. | Asset Management Policy, SoA A.5.13 | Correct the SoA A.5.13 justification to reflect actual state. | (Planned) Implement an information-labelling procedure defining how each classification tier is marked (document headers, file/folder naming, metadata, per-tenant tagging for health data) and record it in the Asset Management Policy. Target: within 6 months. | Firas Kassoumeh | 🔄 In progress |
| NC-2026-04 | NC (Minor) | A.5.35 | Nonconformity | The external Security Officer is referenced as a compensating control but not formally defined in terms of frequency, scope, or qualifications. | The Security Officer was introduced in the Segregation-of-Duties statement at concept level only; its terms of reference were never formalized. | Governance (Segregation of Duties §4.6), Independent Review | Define the Security Officer role formally. | (Planned) Add a "Security Officer — Terms of Reference" defining appointee, required qualifications, review scope, and frequency; schedule the independent review in the Audit Calendar. Target: within 6 months. | Firas Kassoumeh | 🔄 In progress |
| NC-2026-05 | NC (Minor) | NEN 7510 A.8.5 | Nonconformity | MFA phrasing was read as "recommended" rather than mandatory for privileged access to systems processing health data. | The Access Control Policy already mandates MFA (§5), but the SoA/NEN A.8.5 wording did not clearly document that the production CMS — which cannot support native MFA and processes health data — relies on IP-whitelisting as a formal compensating control, creating ambiguity. | Access Control Policy §5, SoA/NEN A.8.5 | Confirm MFA is stated as mandatory (already the case, §5). | (Planned) Clarify SoA/NEN A.8.5 to state MFA is mandatory and document the CMS IP-whitelisting compensating control (native MFA unsupported) as a risk-accepted exception per Risk #28. Target: within 6 months. | Firas Kassoumeh | 🔄 In progress |
...
| OFI-2026-03 | 10.2 | Align the incident-management process with the nonconformity/corrective-action process and deepen root-cause analysis (e.g. 5-Whys). | Adopt a structured RCA method; cross-link both workflows. | Firas Kassoumeh | Open |
| OFI-2026-04 | A.5.35 / A.8.8 | No technical vulnerability scan of production infrastructure, VPN, and NAS evidenced; endpoint patching is not a vulnerability scan. | Perform a documented vulnerability scan with findings + treatment plan; add to Audit Calendar. | Firas Kassoumeh | Open |
| OFI-2026-05 | A.5.9 | Asset register layout/formatting not fully aligned; correct for consistency and readability. | Reformat the asset inventory for consistency. | Firas Kassoumeh | Open |

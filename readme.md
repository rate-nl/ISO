...
| NC-2026-02 | NC (Minor) | 7.2 | Nonconformity | Retained evidence of competence does not demonstrate the organization's own stated competence requirements; external Security Officer role lacks defined competence requirements. | Competence requirements were defined narratively per role, but the ISMS never required objective evidence (CVs, certificates, training mapped to competencies) to be retained; the Security Officer role had no competence profile. | Competence (Info Security Policy §4), Security Officer role | Added an "Evidence of Competence (Clause 7.2)" clause requiring competence evidence to be retained and reviewed. | Info Security Policy §4.5 now requires CVs, certifications, and training records mapped to each role's competencies, retained in HR records and reviewed annually; Security Officer competence defined via the Terms of Reference (§4.6). | Firas Kassoumeh | ✅ Closed (pending CEO verification) |
...
| NC-2026-04 | NC (Minor) | A.5.35 | Nonconformity | The external Security Officer is referenced as a compensating control but not formally defined in terms of frequency, scope, or qualifications. | The Security Officer was introduced in the Segregation-of-Duties statement at concept level only; its terms of reference were never formalized. | Governance (Segregation of Duties §4.6), Independent Review | Added a "Security Officer — Terms of Reference" defining appointee, qualifications, scope, and frequency. | ToR added (§4.6) — appointee Jaguar IT / Steven Vogelaar, at least annual independent review, defined scope and qualifications; SoA A.5.35 updated to reference the ToR. | Firas Kassoumeh | ✅ Closed (pending CEO verification) |

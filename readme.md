...
| A.8.5 | Secure authentication | ✅ | MFA is mandatory for access to systems processing health-related personal data. Where a system cannot support native MFA (the CMS), a documented compensating control applies — static IP whitelisting restricting access to known endpoints — assessed and risk-accepted (Risk #28). | Team Lead Developer |

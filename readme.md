...
| A.5.7                 | Threat intelligence                                         | ✅       | CrowdSec provides community-driven threat feeds and automated blocking.             | Secure Development & Change Management                                            | Team Lead Developer
                                    |
| A.5.8                 | Information security in project management                  | ❌       | Already integrated into secure development process; no separate project mgmt. control needed.     | N/A                                            | N/A                                     | A.5.9                 | Inventory of information and other associated assets        | ✅       | Prevents data loss by ensuring all assets are accounted for.                                      | Asset Management Policy                         | Managing Director, Team Lead Developer |

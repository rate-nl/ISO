...
|----------------|----------------|---------------------|----------------|------------------------------------------------------------------------------------------|------------------------------------------------------|--------------------------------------|----------------------------------------------------|--------------------------------------------------------------------|------------------------------------------------------|----------------------|----------|
| NC-2025-EXT-01 | NC (Minor)     | 4.1                 | Nonconformity  | No evidence provided that climate change was assessed as a relevant context issue.       | Context analysis template did not include climate change factor. | ISMS Context & Risk Register         | Add climate change consideration to context analysis. | Update ISMS context template and risk register to include climate change relevance. | Planned 19 Sept 2025                                   | Firas     | 🔄 Open  |
